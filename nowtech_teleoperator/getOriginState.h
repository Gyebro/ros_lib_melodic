...
static const char GETORIGINSTATE[] = "nowtech_teleoperator/getOriginState";
  ...
  class getOriginStateRequest : public ros::Msg
  {
    ...
    const char * getType(){ return GETORIGINSTATE; };
    const char * getMD5(){ return "c6c652c55c7cc17ea16326e27a6bedeb"; };
  ...
  class getOriginStateResponse : public ros::Msg
  {
    ...
    const char * getType(){ return GETORIGINSTATE; };
    const char * getMD5(){ return "d6448d9f3ae1fddf43d67ec127f71c40"; };
